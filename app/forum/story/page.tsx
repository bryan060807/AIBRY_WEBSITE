...
interface PostType {
    ...
    topic: string;
    title: string;
    // This correctly types the joined user data as an array, which is required for the fix below
...
  const { data: postsData, error } = await supabase // Renamed variable for type casting below
    .from('posts')
