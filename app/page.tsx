...
const LiveReview = dynamic(() => import("./sections/LiveReview"), {
  ssr: false,
...
// Artist structured data for SEO
const artistSchema = {
...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-black text-gray-100">
      ...
      {/* Live Review Section */}
      <LiveReview
        title="Live Review: AIBRY on Stream"
        videoSrc="https://www.youtube.com/embed/Z38Mjfj3Owo?si=UXdKVtN01OoNOlhR"
        description="Experience the raw energy of AIBRY live — unfiltered and unapologetic."
      />
      ...
      <LatestRelease
        ...
        links={[
          {
            name: "YouTube",
            href: "https://www.youtube.com/watch?v=BMv0DSq87lA&list=OLAK5uy_mLnPdMz9uvtSJC28MOniIn6lZ5Ycixedo",
          },
          {
            name: "Spotify",
            href: "https://open.spotify.com/artist/6gw6SIOYGPhuMqOfLwJE9h",
      ...
      <section className="relative py-24 bg-gradient-to-t from-black via-gray-900 to-black text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-8">
            ...
            unflinching honesty. Every track is a reflection of chaos, control,
            and catharsis.
          </p>
          <Link
            href="/about"
      ...
      <footer className="border-t border-gray-800 bg-black text-center py-6 text-sm text-gray-500">
        <p>
          © {new Date().getFullYear()} AIBRY. Built for the broken and the
          bold.
        </p>
      </footer>
    </main>
